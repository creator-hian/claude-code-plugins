...
|--------|-------|-------------|
| `--model` | `-m` | Model: `gpt-5.1-codex-max`, `gpt-5.1-codex`, `gpt-5.1-codex-mini`, `gpt-5.1` |
...
# Model selection
codex exec -m gpt-5.1-codex-max "Complex security audit"
...
codex exec -m gpt-5.1-codex-max -c model_reasoning_effort=xhigh -s read-only "Maximum depth audit"
