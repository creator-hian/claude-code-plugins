...
|--------|-------|-------------|
| `--model` | `-m` | Model: `gpt-5.3-codex`, `gpt-5.2`, `gpt-5.1-codex-max`, `gpt-5-codex-mini` |
...
# Model selection
codex exec -m gpt-5.3-codex "Complex security audit"
codex exec -m gpt-5.2 "General analysis"
codex exec -m gpt-5-codex-mini "Quick syntax check"
...
codex exec -m gpt-5.3-codex -c model_reasoning_effort=xhigh -s read-only "Maximum depth audit"
