...
| `--model` | `-m` | Model selection | `gemini -m gemini-3-flash-preview` |
...
|-----------|-------------------|
| Standard code review | `gemini-3-flash-preview` (DEFAULT) |
...
**Example Stream:**
```jsonl
{"type":"init","session_id":"abc123","model":"gemini-3-flash-preview"}
